...
bra_usa_can = athletes.loc[
    (athletes['nationality'] == 'BRA') | 
    (athletes['nationality'] == 'USA') | 
    (athletes['nationality'] == 'CAN'), :].copy()

def q5():
    alpha = 0.05    
    bra = bra_usa_can.loc[bra_usa_can['nationality'] == 'BRA', 'height'].copy()
    usa = bra_usa_can.loc[bra_usa_can['nationality'] == 'USA', 'height'].copy()    
...
def q6():
    alpha = 0.05    
    bra = bra_usa_can.loc[bra_usa_can['nationality'] == 'BRA', 'height'].copy()
    can = bra_usa_can.loc[bra_usa_can['nationality'] == 'CAN', 'height'].copy()    
